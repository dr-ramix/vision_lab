"""
EmoCatNets-v2 (64x64 FER) — NO STN + stem (NO residual stem)

Removed:
- STNLayer
- ResidualSTN
- all STN args + factory flags
- STN identity re-zero logic

Change requested:
- Removed CBAM in stage 4 (no cbam4 module, no x = self.cbam4(x))
"""
