# fer/models/resnet101_fine.py
# ============================================================
# Fine-tuning for ResNet101FER
#
# Transfers timm ResNet-101 pretrained weights into:
#   - conv1, bn1
...
from fer.models.resnet101 import ResNet101FER
...
@torch.no_grad()
def transfer_resnet101_into_resnet101fer(
    model: nn.Module,
    resnet_name: str = "resnet101",
    pretrained: bool = True,
    verbose: bool = True,
) -> Dict[str, int]:
    """
    timm ResNet-101 -> your ResNet101FER
    ...
    if verbose:
        print(
            f"[resnet101 transfer] pretrained={pretrained} | "
...
def resnet101fine_fer(
    ...
    **kwargs,
    ...
    transfer=True loads timm ResNet-101 weights into conv + layers
    """
    ...
    if transfer:
        transfer_resnet101_into_resnet101fer(
            model=model,
...
def make_resnet101_param_groups(
    model: nn.Module,
    base_lr: float,
