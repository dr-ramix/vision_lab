...
# Default builders
# ============================================================
@register_dataloader("main", "default", "npy", "all", "total")
def _build_main(settings, images_root: Path) -> Tuple[Any, list[str], Dict[str, int]]:
    from fer.dataset.dataloaders.dataloader_main import (
    ...
    # prefer returned mapping if present (future-proof)
