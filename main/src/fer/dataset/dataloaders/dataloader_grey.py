# file: vision_lab/main/src/fer/dataset/dataloaders/dataloader_grey.py
...
def _resolve_grey_paths(standardized_root: Path) -> Tuple[Path, Path]:
    ...
    if standardized_root.name == "npy" and standardized_root.parent.name == "grey":
...
def build_dataloaders(
    *,
    ...
    actual data:
      .../standardized/only_mtcnn_cropped/grey/npy/{train,val,test}/{class}/*.npy

    stats:
      .../standardized/only_mtcnn_cropped/grey/dataset_stats_train.json
    """
    images_root = Path(images_root)

    npy_root, default_stats = _resolve_grey_paths(images_root)
    ...
    if not npy_root.exists():
        raise FileNotFoundError(f"Grey npy root not found: {npy_root}")
