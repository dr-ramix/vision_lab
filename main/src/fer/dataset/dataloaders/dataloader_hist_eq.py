# file: vision_lab/main/src/fer/dataset/dataloaders/dataloader_mtcnn_cropped_norm.py
...
def _resolve_mtcnn_cropped_norm_paths(standardized_root: Path) -> Tuple[Path, Path]:
    ...
    if standardized_root.name == "npy" and standardized_root.parent.name == "images_mtcnn_cropped_norm":
    ...
    if standardized_root.name == "images_mtcnn_cropped_norm":
...
def build_dataloaders(
    *,
    ...
    actual data:
      .../standardized/images_mtcnn_cropped_norm/npy/{train,val,test}/{class}/*.npy

    stats:
      .../standardized/images_mtcnn_cropped_norm/dataset_stats_train.json
    """
    images_root = Path(images_root)

    npy_root, default_stats = _resolve_mtcnn_cropped_norm_paths(images_root)
